 ...
 * const authority2 = getAuthority( 'https://current.whitepants.io:8080/test/' ); // 'localhost:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'https://current.whitepants.io:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'https://current.whitepants.io:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'https://current.whitepants.io:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'https://current.whitepants.io:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
